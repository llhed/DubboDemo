 ...
 */
(function($){
	var currentDialogId = "";//2013-10-24 add by huangbin and Lim（解决二级dialog刷新一级dialog问题）
	$.pdialog = {
		...
		open:function(url, dlgid, title, options) {
			currentDialogId = dlgid; //2013-10-24 add by huangbin and Lim（解决二级dialog刷新一级dialog问题）
